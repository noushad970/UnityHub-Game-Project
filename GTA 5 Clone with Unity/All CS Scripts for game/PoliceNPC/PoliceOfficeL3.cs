...
public class PoliceOfficeL3 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!playerInshootRadius && playerInvisionRadius && wantedLevelScript.wantedLevel3 == true || wantedLevelScript.wantedLevel4 == true || wantedLevelScript.wantedLevel5 == true)
        {
            ChasePlayer();
        }
        if (playerInshootRadius && playerInvisionRadius && wantedLevelScript.wantedLevel3 == true || wantedLevelScript.wantedLevel4 == true || wantedLevelScript.wantedLevel5 == true)
