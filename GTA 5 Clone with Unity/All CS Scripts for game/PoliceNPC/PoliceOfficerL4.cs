...
public class PoliceOfficerL4 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!playerInshootRadius && playerInvisionRadius &&  wantedLevelScript.wantedLevel4 == true || wantedLevelScript.wantedLevel5 == true)
        {
            ChasePlayer();
        }
        if (playerInshootRadius && playerInvisionRadius &&wantedLevelScript.wantedLevel4 == true || wantedLevelScript.wantedLevel5 == true)
