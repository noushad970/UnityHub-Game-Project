...
public class UZI1 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (uzi1Active == true)
        {
            animator.runtimeAnimatorController = Resources.Load<RuntimeAnimatorController>("UziAnimation");
        }
